...
public class DApAprovDApApresDVchrLnVwDDistrLnVwCollection implements IDApAprovDApApresDVchrLnVwDDistrLnVwCollection 
  {
  public DApAprovDApApresDVchrLnVwDDistrLnVwCollection(IObject oThis) { m_oThis = oThis; }
  ...
  public IDApAprovDApApresDVchrLnVwDDistrLnVw item(long Index) throws JOAException {
    ...
    return (IDApAprovDApApresDVchrLnVwDDistrLnVw)m_oThis.invokeMethod("Item", args);
    }

  public IDApAprovDApApresDVchrLnVwDDistrLnVw insertItem(long Index) throws JOAException {
    Object[] args = new Object[1];
    args[0] = new Long(Index);
    return (IDApAprovDApApresDVchrLnVwDDistrLnVw)m_oThis.invokeMethod("InsertItem", args);
    }
  ...
  public IDApAprovDApApresDVchrLnVwDDistrLnVw itemByKeys() throws JOAException {
    ...
    return (IDApAprovDApApresDVchrLnVwDDistrLnVw)m_oThis.invokeMethod("ItemByKeys", args);
    }

  public IDApAprovDApApresDVchrLnVwDDistrLnVw currentItem() throws JOAException {
    Object[] args = new Object[0];
    return (IDApAprovDApApresDVchrLnVwDDistrLnVw)m_oThis.invokeMethod("CurrentItem", args);
    }
  ...
  public IDApAprovDApApresDVchrLnVwDDistrLnVw getEffectiveItem(String Date, long SeqNum) throws JOAException {
    ...
    return (IDApAprovDApApresDVchrLnVwDDistrLnVw)m_oThis.invokeMethod("GetEffectiveItem", args);
    }
