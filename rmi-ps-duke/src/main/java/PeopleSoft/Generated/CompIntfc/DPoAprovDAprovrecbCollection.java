...
public class DPoAprovDAprovrecbCollection implements IDPoAprovDAprovrecbCollection 
  {
  public DPoAprovDAprovrecbCollection(IObject oThis) { m_oThis = oThis; }
  ...
  public IDPoAprovDAprovrecb item(long Index) throws JOAException {
    ...
    return (IDPoAprovDAprovrecb)m_oThis.invokeMethod("Item", args);
    }

  public IDPoAprovDAprovrecb insertItem(long Index) throws JOAException {
    Object[] args = new Object[1];
    args[0] = new Long(Index);
    return (IDPoAprovDAprovrecb)m_oThis.invokeMethod("InsertItem", args);
    }
  ...
  public IDPoAprovDAprovrecb itemByKeys(String DExDtEncam) throws JOAException {
    Object[] args = new Object[1];
    args[0] = DExDtEncam;
    return (IDPoAprovDAprovrecb)m_oThis.invokeMethod("ItemByKeys", args);
    }

  public IDPoAprovDAprovrecb currentItem() throws JOAException {
    Object[] args = new Object[0];
    return (IDPoAprovDAprovrecb)m_oThis.invokeMethod("CurrentItem", args);
    }
  ...
  public IDPoAprovDAprovrecb getEffectiveItem(String Date, long SeqNum) throws JOAException {
    ...
    return (IDPoAprovDAprovrecb)m_oThis.invokeMethod("GetEffectiveItem", args);
    }
