	    	...
	    	<div class="content" id="contentFull">
				...
				<div class="body">
					...
					<table class="gridContent">
						<tr>
							<th class="left" width="150px">Nome</th>
							...
							<@s.iterator value="allConnectors" status="stat">
							<tr class="active" valign="middle" <#if stat.odd>class="active"</#if>>
								<td ><a href='connectors!edit.action?id=<@s.property value="id"/>' title="Editar" ><@s.property value="name"/></a></td>
