...
public class DApAprovDApApresDPymntXrefVwCollection implements IDApAprovDApApresDPymntXrefVwCollection 
  {
  public DApAprovDApApresDPymntXrefVwCollection(IObject oThis) { m_oThis = oThis; }
  ...
  public IDApAprovDApApresDPymntXrefVw item(long Index) throws JOAException {
    ...
    return (IDApAprovDApApresDPymntXrefVw)m_oThis.invokeMethod("Item", args);
    }

  public IDApAprovDApApresDPymntXrefVw insertItem(long Index) throws JOAException {
    Object[] args = new Object[1];
    args[0] = new Long(Index);
    return (IDApAprovDApApresDPymntXrefVw)m_oThis.invokeMethod("InsertItem", args);
    }
  ...
  public IDApAprovDApApresDPymntXrefVw itemByKeys() throws JOAException {
    ...
    return (IDApAprovDApApresDPymntXrefVw)m_oThis.invokeMethod("ItemByKeys", args);
    }

  public IDApAprovDApApresDPymntXrefVw currentItem() throws JOAException {
    Object[] args = new Object[0];
    return (IDApAprovDApApresDPymntXrefVw)m_oThis.invokeMethod("CurrentItem", args);
    }
  ...
  public IDApAprovDApApresDPymntXrefVw getEffectiveItem(String Date, long SeqNum) throws JOAException {
    ...
    return (IDApAprovDApApresDPymntXrefVw)m_oThis.invokeMethod("GetEffectiveItem", args);
    }
